...
class IgnoredDistributionTestCase(StatsTestClass):
    ...
    def setUp(self) -> None:
        ...
        self._ests = [GaussianEstimator(), GeometricEstimator()]
        self._facts = [GaussianAccumulatorFactory(), GeometricAccumulatorFactory()]
        self._accs = [GaussianAccumulator(), GeometricAccumulator()]
        self._encs = [GaussianDataEncoder(), GeometricDataEncoder()]
