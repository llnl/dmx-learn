    ...
    def setUp(self) -> None:
        ...
        self._encoders = [
            HiddenMarkovDataEncoder(
                emission_encoder=CategoricalDataEncoder(),
                len_encoder=CategoricalDataEncoder(),
            ),
            HiddenMarkovDataEncoder(
                emission_encoder=CategoricalDataEncoder(),
                len_encoder=CategoricalDataEncoder(),
            ...
            HiddenMarkovDataEncoder(
                emission_encoder=GaussianDataEncoder(),
                len_encoder=CategoricalDataEncoder(),
            ),
        ]
        self._estimators = [
            ...
            HiddenMarkovEstimator(
                estimators=self._ests[0], len_estimator=CategoricalEstimator()
            ),
            HiddenMarkovEstimator(
        ...
        self._accumulators = [
            ...
            HiddenMarkovAccumulator(
                accumulators=self._accs[0], len_accumulator=CategoricalAccumulator()
            ),
            HiddenMarkovAccumulator(
        ...
        self._factories = [
            ...
            HiddenMarkovAccumulatorFactory(
                factories=self._facts[0], len_factory=CategoricalAccumulatorFactory()
            ),
            HiddenMarkovAccumulatorFactory(
