...
if __name__ == "__main__":
    ...
    # Define the model
    len_dist = CategoricalDistribution(pmap={10: 0.5, 20: 0.5})
    p = np.ones(10) / 10.0
    dist = IntegerMultinomialDistribution(min_val=0, p_vec=p, len_dist=len_dist)
    ...
    # Estimate model
    model = optimize(data=data, estimator=est, rng=rng, max_its=1000, print_iter=100)
    print(model)
